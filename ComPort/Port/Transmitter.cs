...
namespace ComPort
{
    ...
    class Transmitter
    {
        ...
        public void Write(Win32ComPort port, byte[] data)
        {
            if (writeTaskIsRunning) StopCyclicWrite();

            port.Write(data, 0, data.Length);
            if (display != null) { display.DataWritten(data, data.Length, 0); }
        }
        ...
        public void RunCyclicWrite(Win32ComPort port, int period, ICycleWriteSubject cycleWriteSubject, Action readDisplay)
        {
