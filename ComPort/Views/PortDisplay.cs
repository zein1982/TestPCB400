...
namespace ComPort
{
    public partial class MainWindow
    {
        ...
        class PortDisplay : IPortDisplay
        {
            ...
            /// </summary>
            private const int N_LINE_MAX = 2000;
            ...
            /// </summary>
            /// <param name="data">Массив данных для отображения</param>
            ...
            public void DataWritten(byte[] data, int count, uint index) { if(showWrite) AddData(data, count, true); }
            ...
            private void AddData(byte[] data, int count, bool redColor)
            {
