...
namespace Test20311M
{
    ...
    class Receiver
    {
        ...
        /// </summary>
        private const int MAX_DATA = 10000;
        ...
        public Receiver(IPortDisplay display)
        {
            this.display = display;
            readTaskState = ReadTaskState.stNotRunning;
            suspendObj = new ManualResetEvent(true);
        ...
        public void Read(IReadDisplay readDisplay, int readingDelay = 0)
        {
        ...
        public void Start(GeneralPort port)
        {
